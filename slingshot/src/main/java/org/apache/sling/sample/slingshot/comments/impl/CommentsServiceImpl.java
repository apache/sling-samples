...
public class CommentsServiceImpl implements CommentsService {
     ...
     */
    @Override
    public void addComment(final Resource resource, final Comment c) throws PersistenceException {
        ...
        final Resource ratingsResource =
                ResourceUtil.getOrCreateResource(resource.getResourceResolver(), commentsPath, props, null, true);
